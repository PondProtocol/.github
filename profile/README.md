...
| --- | --- | --- |
| [**protocol**](https://github.com/PondProtocol/Protocol) | The protocol itself — design and mechanism that sits on top of the two tokens. | Scaffolding; README only so far |
| [**pnd**](https://github.com/PondProtocol/PND) | \$PND, the IOU. Home for issued-currency specifics as they split out of the toolkit. | Scaffolding; README only so far |
| [**rpnd**](https://github.com/PondProtocol/rPND) | \$rPND, the MPT — and today the working issuance toolkit for **both** tokens: `config/tokens.json`, XLS-26/XLS-89 metadata, and a TypeScript CLI. Apache-2.0. | Active |

> If a link above 404s for you, that repository is still private.

## Where to start

**Reading about the tokens** — [`docs/tokens.md`](https://github.com/PondProtocol/rPND/blob/main/docs/tokens.md) defines the identity of each asset; [`docs/issuance.md`](https://github.com/PondProtocol/rPND/blob/main/docs/issuance.md) covers accounts, the issuance sequence, and metadata publication.
